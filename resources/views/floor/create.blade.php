    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('floor.store') }}" method="post" id="formAdd" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <div class="card">
                                   ...
                                   <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Contoh: Lantai 1">
                                                @error('name')
