                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('room-types.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                                </div>
                                <!-- /.card-tools -->
                            </div>
                            <div class="card-body">
        ...
        const table = $('#data_table').DataTable({
            ...
            columns: [
                ...
                },
                {
                    data: null,
                    render : function(data, type, row){
                        return  '<a href="{{ route("room-types.index") }}/edit/'+data.id+'" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a> &nbsp' +
