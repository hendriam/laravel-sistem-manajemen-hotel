    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-8">
                        <form action="{{ route('user.store') }}" method="post" id="formAdd" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" placeholder="rath.dannie">
                                        @error('username')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
